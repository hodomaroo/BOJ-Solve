# [Gold V] Count Circle Groups - 10216 

[문제 링크](https://www.acmicpc.net/problem/10216) 

### 성능 요약

메모리: 175844 KB, 시간: 15968 ms

### 분류

자료 구조(data_structures), 깊이 우선 탐색(dfs), 분리 집합(disjoint_set), 기하학(geometry), 그래프 이론(graphs), 그래프 탐색(graph_traversal)
